return {
    ...
    misc={
        ...
        dictionary={
            ...
            b_sandbox="Sandbox",
            b_joker_slots="Joker Slots",
            b_consumable_slots="Consumable Slots",
            b_hands="Hands",
            b_discards="Discards",
            b_dollars="Dollars",
            b_start_sandbox="Play Sandbox",
            b_select_jokers="Select Starting Jokers",
            b_starting_jokers="Starting Jokers",
